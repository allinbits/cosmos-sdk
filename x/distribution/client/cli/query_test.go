...
func TestCalculateValidatorRewardsAndCommissionPerDay(t *testing.T) {
	...
	valuePerBlock := []map[string]sdk.DecCoins{
		{
			validator1.String(): {sdk.DecCoin{"atom", sdk.NewDec(0)}},
			validator2.String(): {sdk.DecCoin{"atom", sdk.NewDec(0)}},
		},
		{
			validator1.String(): {sdk.DecCoin{"atom", sdk.NewDec(1)}},
			validator2.String(): {sdk.DecCoin{"atom", sdk.NewDec(10)}},
		},
		{
			validator1.String(): {sdk.DecCoin{"atom", sdk.NewDec(5)}},
			validator2.String(): {sdk.DecCoin{"atom", sdk.NewDec(25)}},
		},
		{
			validator1.String(): {sdk.DecCoin{"atom", sdk.NewDec(55)}},
			validator2.String(): {sdk.DecCoin{"atom", sdk.NewDec(125)}},
		},
		{
			validator1.String(): {sdk.DecCoin{"atom", sdk.NewDec(65)}},
			validator2.String(): {sdk.DecCoin{"atom", sdk.NewDec(150)}},
		},
		{
			validator1.String(): {sdk.DecCoin{"atom", sdk.NewDec(85)}},
			validator2.String(): {sdk.DecCoin{"atom", sdk.NewDec(250)}},
		},
		{
			validator1.String(): {sdk.DecCoin{"atom", sdk.NewDec(115)}},
			validator2.String(): {sdk.DecCoin{"atom", sdk.NewDec(350)}},
		},
	}
	...
	expected1 := [][]sdk.DecCoins{
		...
		{
			{
				sdk.DecCoin{"atom", sdk.NewDec(80)},
			},
			{
				sdk.DecCoin{"atom", sdk.NewDec(80)},
			},
