...
func TestRandomizedGenState(t *testing.T) {
	...
	assert.Equal(t, "20h4m3s", govGenesis.Params.QuorumTimeout.String())
	assert.Equal(t, "60h4m46s", govGenesis.Params.MaxVotingPeriodExtension.String())
	assert.Equal(t, uint64(6), govGenesis.Params.QuorumCheckCount)
