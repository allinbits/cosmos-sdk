...
var _ protoreflect.List = (*_QuorumCheckQueueEntry_3_list)(nil)

type _QuorumCheckQueueEntry_3_list struct {
	list *[]*timestamppb.Timestamp
}

func (x *_QuorumCheckQueueEntry_3_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_QuorumCheckQueueEntry_3_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_QuorumCheckQueueEntry_3_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*timestamppb.Timestamp)
	(*x.list)[i] = concreteValue
}

func (x *_QuorumCheckQueueEntry_3_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*timestamppb.Timestamp)
	*x.list = append(*x.list, concreteValue)
}

func (x *_QuorumCheckQueueEntry_3_list) AppendMutable() protoreflect.Value {
	v := new(timestamppb.Timestamp)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QuorumCheckQueueEntry_3_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_QuorumCheckQueueEntry_3_list) NewElement() protoreflect.Value {
	v := new(timestamppb.Timestamp)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_QuorumCheckQueueEntry_3_list) IsValid() bool {
	return x.list != nil
}
...
var (
	...
	fd_QuorumCheckQueueEntry_quorum_check_timestamps protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_QuorumCheckQueueEntry_quorum_check_timestamps = md_QuorumCheckQueueEntry.Fields().ByName("quorum_check_timestamps")
}
...
func (x *fastReflection_QuorumCheckQueueEntry) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if len(x.QuorumCheckTimestamps) != 0 {
		value := protoreflect.ValueOfList(&_QuorumCheckQueueEntry_3_list{list: &x.QuorumCheckTimestamps})
		if !f(fd_QuorumCheckQueueEntry_quorum_check_timestamps, value) {
			return
		}
	}
}
...
func (x *fastReflection_QuorumCheckQueueEntry) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.gov.v1.QuorumCheckQueueEntry.quorum_check_timestamps":
		return len(x.QuorumCheckTimestamps) != 0
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_QuorumCheckQueueEntry) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1.QuorumCheckQueueEntry.quorum_check_timestamps":
		if len(x.QuorumCheckTimestamps) == 0 {
			return protoreflect.ValueOfList(&_QuorumCheckQueueEntry_3_list{})
		}
		listValue := &_QuorumCheckQueueEntry_3_list{list: &x.QuorumCheckTimestamps}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.QuorumCheckQueueEntry"))
...
func (x *fastReflection_QuorumCheckQueueEntry) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.gov.v1.QuorumCheckQueueEntry.quorum_check_timestamps":
		lv := value.List()
		clv := lv.(*_QuorumCheckQueueEntry_3_list)
		x.QuorumCheckTimestamps = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.QuorumCheckQueueEntry"))
		}
...
func (x *fastReflection_QuorumCheckQueueEntry) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1.QuorumCheckQueueEntry.quorum_check_timestamps":
		if x.QuorumCheckTimestamps == nil {
			x.QuorumCheckTimestamps = []*timestamppb.Timestamp{}
		}
		value := &_QuorumCheckQueueEntry_3_list{list: &x.QuorumCheckTimestamps}
		return protoreflect.ValueOfList(value)
	case "cosmos.gov.v1.QuorumCheckQueueEntry.quorum_check_count":
...
func (x *fastReflection_QuorumCheckQueueEntry) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.gov.v1.QuorumCheckQueueEntry.quorum_check_timestamps":
		list := []*timestamppb.Timestamp{}
		return protoreflect.ValueOfList(&_QuorumCheckQueueEntry_3_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.gov.v1.QuorumCheckQueueEntry"))
		}
...
func (x *fastReflection_QuorumCheckQueueEntry) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		if len(x.QuorumCheckTimestamps) > 0 {
			for _, e := range x.QuorumCheckTimestamps {
				l = options.Size(e)
				n += 1 + l + runtime.Sov(uint64(l))
			}
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.QuorumCheckTimestamps) > 0 {
			for iNdEx := len(x.QuorumCheckTimestamps) - 1; iNdEx >= 0; iNdEx-- {
				encoded, err := options.Marshal(x.QuorumCheckTimestamps[iNdEx])
				if err != nil {
					return protoiface.MarshalOutput{
						NoUnkeyedLiterals: input.NoUnkeyedLiterals,
						Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field QuorumCheckTimestamps", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.QuorumCheckTimestamps = append(x.QuorumCheckTimestamps, &timestamppb.Timestamp{})
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.QuorumCheckTimestamps[len(x.QuorumCheckTimestamps)-1]); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type QuorumCheckQueueEntry struct {
	...
	QuorumCheckTimestamps []*timestamppb.Timestamp `protobuf:"bytes,3,rep,name=quorum_check_timestamps,json=quorumCheckTimestamps,proto3" json:"quorum_check_timestamps,omitempty"`
}
...
func (x *QuorumCheckQueueEntry) GetQuorumCheckTimestamps() []*timestamppb.Timestamp {
	if x != nil {
		return x.QuorumCheckTimestamps
	}
	return nil
}
...
var file_cosmos_gov_v1_gov_proto_rawDesc = []byte{
	...
	,
	...
	0x64, 0x3a, 0x02, 0x18, 0x01, 0x22, 0xa9, 0x09, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73,
	...
	0x75, 0x72, 0x6e, 0x56, 0x6f, 0x74, 0x65, 0x56, 0x65, 0x74, 0x6f, 0x12, 0x46, 0x0a, 0x0e, 0x71,
	0x75, 0x6f, 0x72, 0x75, 0x6d, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x18, 0x10, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x42, 0x04,
	...
	0x65, 0x63, 0x6b, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x12, 0x20, 0x01, 0x28, 0x04, 0x52,
...
var file_cosmos_gov_v1_gov_proto_goTypes = []interface{}{
	...
	(*QuorumCheckQueueEntry)(nil), // 7: cosmos.gov.v1.QuorumCheckQueueEntry
...
var file_cosmos_gov_v1_gov_proto_depIdxs = []int32{
	...
	14, // 11: cosmos.gov.v1.QuorumCheckQueueEntry.quorum_timeout_time:type_name -> google.protobuf.Timestamp
	14, // 12: cosmos.gov.v1.QuorumCheckQueueEntry.quorum_check_timestamps:type_name -> google.protobuf.Timestamp
	12, // 13: cosmos.gov.v1.DepositParams.min_deposit:type_name -> cosmos.base.v1beta1.Coin
	15, // 14: cosmos.gov.v1.DepositParams.max_deposit_period:type_name -> google.protobuf.Duration
	15, // 15: cosmos.gov.v1.VotingParams.voting_period:type_name -> google.protobuf.Duration
	12, // 16: cosmos.gov.v1.Params.min_deposit:type_name -> cosmos.base.v1beta1.Coin
	15, // 17: cosmos.gov.v1.Params.max_deposit_period:type_name -> google.protobuf.Duration
	15, // 18: cosmos.gov.v1.Params.voting_period:type_name -> google.protobuf.Duration
	15, // 19: cosmos.gov.v1.Params.expedited_voting_period:type_name -> google.protobuf.Duration
	12, // 20: cosmos.gov.v1.Params.expedited_min_deposit:type_name -> cosmos.base.v1beta1.Coin
	15, // 21: cosmos.gov.v1.Params.quorum_timeout:type_name -> google.protobuf.Duration
	15, // 22: cosmos.gov.v1.Params.max_voting_period_extension:type_name -> google.protobuf.Duration
