...
type QuorumCheckQueueEntry struct {
	...
	QuorumCheckTimestamps []*time.Time `protobuf:"bytes,3,rep,name=quorum_check_timestamps,json=quorumCheckTimestamps,proto3,stdtime" json:"quorum_check_timestamps,omitempty"`
}
...
func (m *QuorumCheckQueueEntry) GetQuorumCheckTimestamps() []*time.Time {
	if m != nil {
		return m.QuorumCheckTimestamps
	}
	return nil
}
...
type Params struct {
	...
	//
	// Since: cosmos-sdk 0.50
	QuorumTimeout *time.Duration `protobuf:"bytes,16,opt,name=quorum_timeout,json=quorumTimeout,proto3,stdduration" json:"quorum_timeout,omitempty"`
	// Duration that expresses the maximum amount of time by which a proposal voting period
	// can be extended.
	//
	// Since: cosmos-sdk 0.50
	MaxVotingPeriodExtension *time.Duration `protobuf:"bytes,17,opt,name=max_voting_period_extension,json=maxVotingPeriodExtension,proto3,stdduration" json:"max_voting_period_extension,omitempty"`
...
var fileDescriptor_e05cb1c0d030febb = []byte{
	...
	,
}
...
func (m *QuorumCheckQueueEntry) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.QuorumCheckTimestamps) > 0 {
		for iNdEx := len(m.QuorumCheckTimestamps) - 1; iNdEx >= 0; iNdEx-- {
			n, err := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(*m.QuorumCheckTimestamps[iNdEx], dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(*m.QuorumCheckTimestamps[iNdEx]):])
			if err != nil {
				return 0, err
			}
			i -= n
			i = encodeVarintGov(dAtA, i, uint64(n))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.ExpeditedVotingPeriod != nil {
		n11, err11 := github_com_cosmos_gogoproto_types.StdDurationMarshalTo(*m.ExpeditedVotingPeriod, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdDuration(*m.ExpeditedVotingPeriod):])
		if err11 != nil {
			return 0, err11
		}
		i -= n11
...
func (m *QuorumCheckQueueEntry) Size() (n int) {
	...
	if len(m.QuorumCheckTimestamps) > 0 {
		for _, e := range m.QuorumCheckTimestamps {
...
func (m *QuorumCheckQueueEntry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field QuorumCheckTimestamps", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.QuorumCheckTimestamps = append(m.QuorumCheckTimestamps, new(time.Time))
			if err := github_com_cosmos_gogoproto_types.StdTimeUnmarshal(m.QuorumCheckTimestamps[len(m.QuorumCheckTimestamps)-1], dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
